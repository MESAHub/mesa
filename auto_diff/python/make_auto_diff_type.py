...
def make_auto_diff_type(
    auto_diff_type, unary_operators, binary_operators, comparison_operators, intrinsics
):
    """
    ...
    begin = [
        tab + "use const_def, only: dp, ln10, pi",
        tab + "use utils_lib",
        tab + "use support_functions",
        tab + "use math_lib",
    ]
    ...
    lines = (
        header
        + indent_list(begin + type_lines + interfaces)
        + contains
        + indent_list_of_str(functions)
        + ender
    )
