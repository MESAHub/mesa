...
def make_auto_diff_type(auto_diff_type, unary_operators, binary_operators,
                        comparison_operators, intrinsics):
    '''
    Builds the module file defining an auto_diff type along with all
    ...
    for op, opname in comparison_operators:
        ...
        # (auto_diff, auto_diff)
        self_comparison = auto_diff_type.comparison_function_with_self(opname,
                                                                       op)
        ...
        real_comparisons = auto_diff_type.comparison_function_with_real_dp(
            opname, op)
        ...
        int_comparisons = auto_diff_type.comparison_function_with_int(opname,
                                                                      op)
    ...
    for op, opname in binary_operators:
        ...
        function = auto_diff_type.specific_binary_operator_function_self(
            opname, op)
        functions.append(str(function))
        functions.append('')
        ...
        f1, f2 = auto_diff_type.specific_binary_operator_function_real_dp(
            opname, op)
        ...
        f1, f2 = auto_diff_type.specific_binary_operator_function_int(opname,
                                                                      op)
        functions.append(str(f1))
        functions.append('')
        functions.append(str(f2))
    ...
    # Put it all together
    lines = header + indent_list(
        begin + type_lines + interfaces) + contains + indent_list_of_str(
        functions) + ender
