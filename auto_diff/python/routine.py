...
class FortranRoutine:
    def __init__(self, name, arguments, body):
        ...
        self.arguments = arguments  # List of tuples of the form (
        # argument_name, argument_declaration_string, argument_intent)
        self.body = body  # List of lines forming the body of the routine.
    
    def __str__(self):
        '''
        Returns a string representing a valid fortran implementation of this
        routine.
        This involves constructing some boilerplate (the routine declaration
        and ending), as well as all
        ...
        declarations = [tab + arg[1] + ', intent(' + arg[2] + ') :: ' + arg[0]
...
class FortranFunction:
    def __init__(self, name, arguments, result, body):
        ...
        self.arguments = arguments  # List of tuples of the form (
        # argument_name, argument_declaration_string, argument_intent)
        self.result = result  # Tuple (argument_name,
    ...
    def __str__(self):
        ...
        and ending), as well as all
        variable declarations, and putting it together in the right order.
        Note that because this is a function there is an explicitly listed
        return argument, which forms part of the beginning boilerplate.
        '''
