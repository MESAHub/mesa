...
module auto_diff_real_1var_order1_module
   ...
   function safe_sqrt_self(x) result(unary)
      ...
      unary%val = q0
      unary%d1val1 = 0.5_dp*q0*x%d1val1*powm1(max(x%val, 1.E-99_dp))
   ...
   function safe_log_self(x) result(unary)
      ...
      unary%d1val1 = x%d1val1*powm1(max(x%val, 1.E-99_dp))
   ...
   function safe_log10_self(x) result(unary)
      ...
      unary%d1val1 = q0*x%d1val1*powm1(max(x%val, 1.E-99_dp))
