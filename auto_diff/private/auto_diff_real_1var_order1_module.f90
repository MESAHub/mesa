module auto_diff_real_1var_order1_module
   ...
   function tanh_self(x) result(unary)
      ...
      q0 = tanh(x%val)
      unary%val = q0
      unary%d1val1 = x%d1val1*(1 - pow2(q0))
   ...
   function atanh_self(x) result(unary)
      ...
      unary%d1val1 = x%d1val1*powm1(1 - pow2(x%val))
   ...
   function pow_self_real(x, y) result(unary)
      ...
      q0 = pow(x%val, y)
      unary%val = q0
      unary%d1val1 = q0*x%d1val1*y*powm1(x%val)
   ...
   function pow_self_int(x, y) result(unary)
      ...
      q0 = pow(x%val, y_dp)
      unary%val = q0
      unary%d1val1 = q0*x%d1val1*y_dp*powm1(x%val)
