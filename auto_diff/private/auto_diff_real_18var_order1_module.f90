module auto_diff_real_18var_order1_module
      use const_def
      use utils_lib
      ...
      implicit none
      private
   public :: auto_diff_real_18var_order1, &
      assignment(=), &
      operator(.eq.), &
      operator(.ne.), &
      operator(.gt.), &
   ...
   type :: auto_diff_real_18var_order1
      real(dp) :: val
      real(dp) :: d1Array(18)
   end type auto_diff_real_18var_order1
   ...
   interface operator(.eq.)
      ...
      module procedure equal_auto_diff_real_18var_order1_real_dp
      module procedure equal_real_dp_auto_diff_real_18var_order1
      module procedure equal_auto_diff_real_18var_order1_int
      module procedure equal_int_auto_diff_real_18var_order1
   end interface operator(.eq.)
   
   interface operator(.ne.)
      module procedure neq_self
      module procedure neq_auto_diff_real_18var_order1_real_dp
      module procedure neq_real_dp_auto_diff_real_18var_order1
      module procedure neq_auto_diff_real_18var_order1_int
      module procedure neq_int_auto_diff_real_18var_order1
   end interface operator(.ne.)
   
   interface operator(.gt.)
      module procedure greater_self
      module procedure greater_auto_diff_real_18var_order1_real_dp
      module procedure greater_real_dp_auto_diff_real_18var_order1
      module procedure greater_auto_diff_real_18var_order1_int
      module procedure greater_int_auto_diff_real_18var_order1
   end interface operator(.gt.)
   
   interface operator(.lt.)
      module procedure less_self
      module procedure less_auto_diff_real_18var_order1_real_dp
      module procedure less_real_dp_auto_diff_real_18var_order1
      module procedure less_auto_diff_real_18var_order1_int
      module procedure less_int_auto_diff_real_18var_order1
   end interface operator(.lt.)
   
   interface operator(.le.)
      module procedure leq_self
      module procedure leq_auto_diff_real_18var_order1_real_dp
      module procedure leq_real_dp_auto_diff_real_18var_order1
      module procedure leq_auto_diff_real_18var_order1_int
      module procedure leq_int_auto_diff_real_18var_order1
   end interface operator(.le.)
   
   interface operator(.ge.)
      module procedure geq_self
      module procedure geq_auto_diff_real_18var_order1_real_dp
      module procedure geq_real_dp_auto_diff_real_18var_order1
      module procedure geq_auto_diff_real_18var_order1_int
      module procedure geq_int_auto_diff_real_18var_order1
   ...
   subroutine assign_from_self(this, other)
      ...
      type(auto_diff_real_18var_order1), intent(in) :: other
      this%val = other%val
   ...
   function equal_self(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this%val .eq. other%val)
   end function equal_self
   
   function equal_auto_diff_real_18var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .eq. other)
   end function equal_auto_diff_real_18var_order1_real_dp
   
   function equal_real_dp_auto_diff_real_18var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .eq. other%val)
   end function equal_real_dp_auto_diff_real_18var_order1
   
   function equal_auto_diff_real_18var_order1_int(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .eq. other)
   end function equal_auto_diff_real_18var_order1_int
   
   function equal_int_auto_diff_real_18var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .eq. other%val)
   end function equal_int_auto_diff_real_18var_order1
   ...
   function neq_auto_diff_real_18var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .ne. other)
   end function neq_auto_diff_real_18var_order1_real_dp
   
   function neq_real_dp_auto_diff_real_18var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .ne. other%val)
   end function neq_real_dp_auto_diff_real_18var_order1
   
   function neq_auto_diff_real_18var_order1_int(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .ne. other)
   end function neq_auto_diff_real_18var_order1_int
   
   function neq_int_auto_diff_real_18var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .ne. other%val)
   end function neq_int_auto_diff_real_18var_order1
   ...
   function greater_auto_diff_real_18var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .gt. other)
   end function greater_auto_diff_real_18var_order1_real_dp
   
   function greater_real_dp_auto_diff_real_18var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .gt. other%val)
   end function greater_real_dp_auto_diff_real_18var_order1
   
   function greater_auto_diff_real_18var_order1_int(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .gt. other)
   end function greater_auto_diff_real_18var_order1_int
   
   function greater_int_auto_diff_real_18var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .gt. other%val)
   end function greater_int_auto_diff_real_18var_order1
   ...
   function less_auto_diff_real_18var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .lt. other)
   end function less_auto_diff_real_18var_order1_real_dp
   
   function less_real_dp_auto_diff_real_18var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .lt. other%val)
   end function less_real_dp_auto_diff_real_18var_order1
   
   function less_auto_diff_real_18var_order1_int(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .lt. other)
   end function less_auto_diff_real_18var_order1_int
   
   function less_int_auto_diff_real_18var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .lt. other%val)
   end function less_int_auto_diff_real_18var_order1
   ...
   function leq_auto_diff_real_18var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .le. other)
   end function leq_auto_diff_real_18var_order1_real_dp
   
   function leq_real_dp_auto_diff_real_18var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .le. other%val)
   end function leq_real_dp_auto_diff_real_18var_order1
   
   function leq_auto_diff_real_18var_order1_int(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .le. other)
   end function leq_auto_diff_real_18var_order1_int
   
   function leq_int_auto_diff_real_18var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .le. other%val)
   end function leq_int_auto_diff_real_18var_order1
   ...
   function geq_auto_diff_real_18var_order1_real_dp(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      real(dp), intent(in) :: other
      logical :: z
      z = (this%val .ge. other)
   end function geq_auto_diff_real_18var_order1_real_dp
   
   function geq_real_dp_auto_diff_real_18var_order1(this, other) result(z)
      real(dp), intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .ge. other%val)
   end function geq_real_dp_auto_diff_real_18var_order1
   
   function geq_auto_diff_real_18var_order1_int(this, other) result(z)
      type(auto_diff_real_18var_order1), intent(in) :: this
      integer, intent(in) :: other
      logical :: z
      z = (this%val .ge. other)
   end function geq_auto_diff_real_18var_order1_int
   
   function geq_int_auto_diff_real_18var_order1(this, other) result(z)
      integer, intent(in) :: this
      type(auto_diff_real_18var_order1), intent(in) :: other
      logical :: z
      z = (this .ge. other%val)
   end function geq_int_auto_diff_real_18var_order1
   ...
   function make_unary_operator(x, z_val, z_d1x) result(unary)
      ...
      unary%val = z_val
      unary%d1Array(1:18) = x%d1Array(1:18)*z_d1x
   end function make_unary_operator
   
   function make_binary_operator(x, y, z_val, z_d1x, z_d1y) result(binary)
      type(auto_diff_real_18var_order1), intent(in) :: x
      type(auto_diff_real_18var_order1), intent(in) :: y
      real(dp), intent(in) :: z_val
      real(dp), intent(in) :: z_d1x
      real(dp), intent(in) :: z_d1y
      type(auto_diff_real_18var_order1) :: binary
      binary%val = z_val
      binary%d1Array(1:18) = x%d1Array(1:18)*z_d1x + y%d1Array(1:18)*z_d1y
   ...
   function unary_minus_self(x) result(unary)
      ...
      type(auto_diff_real_18var_order1) :: unary
      unary%val = -x%val
      unary%d1Array(1:18) = -x%d1Array(1:18)
   ...
   function expm1_self(x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*exp(x%val)
   ...
   function powm1_self(x) result(unary)
      ...
      unary%d1Array(1:18) = -x%d1Array(1:18)*powm1(pow2(x%val))
   ...
   function log_self(x) result(unary)
      ...
      type(auto_diff_real_18var_order1) :: unary
      unary%val = log(x%val)
      unary%d1Array(1:18) = x%d1Array(1:18)*powm1(x%val)
   ...
   function log1p_self(x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*powm1(x%val + 1)
   ...
   function sin_self(x) result(unary)
      ...
      type(auto_diff_real_18var_order1) :: unary
      unary%val = sin(x%val)
      unary%d1Array(1:18) = x%d1Array(1:18)*cos(x%val)
   ...
   function cos_self(x) result(unary)
      ...
      type(auto_diff_real_18var_order1) :: unary
      unary%val = cos(x%val)
      unary%d1Array(1:18) = -x%d1Array(1:18)*sin(x%val)
   ...
   function sinpi_self(x) result(unary)
      ...
      q0 = pi*x%val
      unary%val = sin(q0)
      unary%d1Array(1:18) = pi*x%d1Array(1:18)*cos(q0)
   ...
   function cospi_self(x) result(unary)
      ...
      q0 = pi*x%val
      unary%val = cos(q0)
      unary%d1Array(1:18) = -pi*x%d1Array(1:18)*sin(q0)
   ...
   function sinh_self(x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*cosh(x%val)
   ...
   function cosh_self(x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*sinh(x%val)
   ...
   function asin_self(x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*powm1(sqrt(1 - pow2(x%val)))
   ...
   function asinpi_self(x) result(unary)
      ...
      unary%d1Array(1:18) = q0*x%d1Array(1:18)*powm1(sqrt(1 - pow2(x%val)))
   ...
   function atanpi_self(x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*powm1(pi*pow2(x%val) + pi)
   ...
   function asinh_self(x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*powm1(sqrt(pow2(x%val) + 1))
   ...
   function sqrt_self(x) result(unary)
      ...
      q0 = sqrt(x%val)
      unary%val = q0
      unary%d1Array(1:18) = 0.5_dp*x%d1Array(1:18)*powm1(q0)
   ...
   function pow2_self(x) result(unary)
      ...
      unary%d1Array(1:18) = 2.0_dp*x%d1Array(1:18)*x%val
   ...
   function pow3_self(x) result(unary)
      ...
      unary%d1Array(1:18) = 3.0_dp*x%d1Array(1:18)*pow2(x%val)
   ...
   function pow4_self(x) result(unary)
      ...
      unary%d1Array(1:18) = 4.0_dp*x%d1Array(1:18)*pow3(x%val)
   ...
   function pow5_self(x) result(unary)
      ...
      unary%d1Array(1:18) = 5.0_dp*x%d1Array(1:18)*pow4(x%val)
   ...
   function pow6_self(x) result(unary)
      ...
      unary%d1Array(1:18) = 6.0_dp*x%d1Array(1:18)*pow5(x%val)
   ...
   function pow7_self(x) result(unary)
      ...
      unary%d1Array(1:18) = 7.0_dp*x%d1Array(1:18)*pow6(x%val)
   ...
   function pow8_self(x) result(unary)
      ...
      unary%d1Array(1:18) = 8.0_dp*x%d1Array(1:18)*pow7(x%val)
   ...
   function abs_self(x) result(unary)
      ...
      type(auto_diff_real_18var_order1) :: unary
      unary%val = Abs(x%val)
      unary%d1Array(1:18) = x%d1Array(1:18)*sgn(x%val)
   ...
   function add_self(x, y) result(binary)
      ...
      binary%d1Array(1:18) = x%d1Array(1:18) + y%d1Array(1:18)
   ...
   function mul_self(x, y) result(binary)
      ...
      type(auto_diff_real_18var_order1) :: binary
      binary%val = x%val*y%val
      binary%d1Array(1:18) = x%d1Array(1:18)*y%val + x%val*y%d1Array(1:18)
   ...
   function mul_self_real(x, y) result(unary)
      ...
      type(auto_diff_real_18var_order1) :: unary
      unary%val = x%val*y
      unary%d1Array(1:18) = x%d1Array(1:18)*y
   ...
   function mul_real_self(z, x) result(unary)
      ...
      type(auto_diff_real_18var_order1) :: unary
      unary%val = x%val*z
      unary%d1Array(1:18) = x%d1Array(1:18)*z
   ...
   function mul_self_int(x, y) result(unary)
      ...
      y_dp = y
      unary%val = x%val*y_dp
      unary%d1Array(1:18) = x%d1Array(1:18)*y_dp
   ...
   function div_self(x, y) result(binary)
      ...
      binary%d1Array(1:18) = (x%d1Array(1:18)*y%val - x%val*y%d1Array(1:18))*powm1(pow2(y%val))
   ...
   function div_real_self(z, x) result(unary)
      ...
      unary%d1Array(1:18) = -x%d1Array(1:18)*z*powm1(pow2(x%val))
   ...
   function div_int_self(z, x) result(unary)
      ...
      unary%d1Array(1:18) = -x%d1Array(1:18)*y_dp*powm1(pow2(x%val))
   ...
   function pow_self(x, y) result(binary)
      ...
      binary%d1Array(1:18) = (x%d1Array(1:18)*y%val + x%val*y%d1Array(1:18)*log(x%val))*pow(x%val, y%val - 1)
   ...
   function pow_real_self(z, x) result(unary)
      ...
      q0 = pow(z, x%val)
      unary%val = q0
      unary%d1Array(1:18) = q0*x%d1Array(1:18)*log(z)
   ...
   function pow_int_self(z, x) result(unary)
      ...
      q0 = pow(y_dp, x%val)
      unary%val = q0
      unary%d1Array(1:18) = q0*x%d1Array(1:18)*log(y_dp)
   ...
   function max_self(x, y) result(binary)
      ...
      binary%d1Array(1:18) = x%d1Array(1:18)*Heaviside(x%val - y%val) + y%d1Array(1:18)*Heaviside(-x%val + y%val)
   ...
   function max_self_real(x, y) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*Heaviside(x%val - y)
   ...
   function max_real_self(z, x) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*Heaviside(x%val - z)
   ...
   function max_self_int(x, y) result(unary)
      ...
      unary%d1Array(1:18) = x%d1Array(1:18)*Heaviside(x%val - y_dp)
   ...
   function dim_self(x, y) result(binary)
      ...
      binary%d1Array(1:18) = -0.5_dp*y%d1Array(1:18) + 0.5_dp*x%d1Array(1:18) + 0.5_dp*(x%d1Array(1:18) - y%d1Array(1:18))*sgn(q0)
