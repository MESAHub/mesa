...
! ***********************************************************************
      ...
      subroutine do_dop853( n,fcn,x,y,xend,h,max_step_size,max_steps,   rtol,atol,itol,solout,iout,work,lwork,iwork,liwork,   lrpar,rpar,lipar,ipar,lout,idid)
! *** *** *** *** *** *** *** *** *** *** *** *** ***
!          declarations
! *** *** *** *** *** *** *** *** *** *** *** *** ***
...
! -------- call to core integrator ------------
      call dp86co(n,fcn,x,y,xend,hmax,h,rtol,atol,itol,lout,   solout,iout,idid,nmax,uround,meth,nstiff,safe,beta,fac1,fac2,   work(iek1),work(iek2),work(iek3),work(iek4),work(iek5),   work(iek6),work(iek7),work(iek8),work(iek9),work(iek10),   work(iey1),work(ieco),iwork(icomp),nrdens,lrpar,rpar,lipar,ipar,   nfcn,nstep,naccpt,nrejct)
      work(7)=h
      iwork(17)=nfcn
      iwork(18)=nstep
      iwork(19)=naccpt
...
!
      subroutine dp86co(n,fcn,x,y,xend,hmax,h,rtol,atol,itol,lout,   solout,iout,idid,nmax,uround,meth,nstiff,safe,beta,fac1,fac2,   k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,y1,rwork,icomp,nrd,lrpar,rpar,lipar,ipar,   nfcn,nstep,naccpt,nrejct)
! ----------------------------------------------------------
...
!
      function hinit(n,fcn,x,y,xend,posneg,f0,f1,y1,iord,   hmax,atol,rtol,itol,lrpar,rpar,lipar,ipar,ierr)
! ----------------------------------------------------------
