...
#include "num_root_fcn.dek"
      ...
      do_safe_root_with_brackets = eval_brent_safe_zero(x1_in, x3_in, 1d-14, &
                                                        epsx, epsy, f, y1_in, y3_in, lrpar, rpar, lipar, ipar, ierr)

   end function do_safe_root_with_brackets

   real(dp) function do_safe_root_with_guess(f, x_guess, dx, x1_in, x3_in, y1_in, y3_in, &
