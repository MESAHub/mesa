...
C
        CALL interp_CSHEP2_db (N,X,Y,W,NC,NW,NR, LCELL,LNEXT,XMIN,
...
C
        ...
        DO 10 I = 1,NI
          DO 9 J = 1,NI
            IER = 0
            PW = interp_CS2VAL_db (P(I),P(J),N,X,Y,W,NR,LCELL,LNEXT,
...
C Print formats:
C
  200 FORMAT ('RENKA790_db: Node set ',I2,4X,'N =',I4,4X,'NI = ',I2,
