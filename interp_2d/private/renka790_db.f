...
!               indexes.  Refer to Subroutine STORE2_db.
...
! Modules required by CSHEP2:  GETNP2_db, GIVENS_db, ROTATE_db,
!                                SETUP2_db, STORE2_db
...
!                weights for C(K) (see Subroutine SETUP2_db)
...
! Duplicate nodes were encountered by GETNP2_db.
...
! CS2HES_db may be called to compute a value, first partial
...
! Modules required by CS2HES_db:  None

! Intrinsic functions called by CS2HES_db:  INT, SQRT
...
! Subroutine STORE2_db, this subroutine uses the cell method to
...
! from their values on output from Subroutine STORE2_db.
...
! Modules required by GETNP2_db:  None

! Intrinsic functions called by GETNP2_db:  ABS, INT, SQRT
...
! (transposed).  Subroutine ROTATE_db may be called to apply
...
! Modules required by GIVENS_db:  None

! Intrinsic functions called by GIVENS_db:  ABS, SQRT
...
! Modules required by ROTATE_db:  None
...
! Modules required by SETUP2_db:  None

! Intrinsic function called by SETUP2_db:  SQRT
...
! Modules required by STORE2_db:  None

! Intrinsic functions called by STORE2_db:  DBLE, INT
