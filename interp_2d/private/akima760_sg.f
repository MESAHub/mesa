...
! Format statements for error messages
 ...
 9020 FORMAT (1X,/,'*** RGSF3P_sg Error 3: Identical XD values or',   ' XD values out of sequence',/,'    IX =',I6,',  XD(IX) =',   E11.3)
 9030 FORMAT (1X,/,'*** RGSF3P_sg Error 4: Identical YD values or',   ' YD values out of sequence',/,'    IY =',I6,',  YD(IY) =',   E11.3)
...
!     ..
!     .. Local Arrays ..
      real             :: B00XA(4),B00YA(4),B01A(4),B10A(4),CXA(3,4),   CYA(3,4),SXA(4),SXXA(4),SYA(4),SYYA(4),XA(3,4),   YA(3,4),Z0IA(3,4),ZI0A(3,4)
      integer          :: IDLT(3,4)
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC        MAX
...
!     ..
!     .. Array Arguments ..
      real             :: PDD(3,NXD,NYD),XD(NXD),XI(NIP),YD(NYD),YI(NIP),   ZD(NXD,NYD),ZI(NIP)
      integer          :: INXI(NIP),INYI(NIP)
!     ..
!     .. Local Scalars ..
      real             :: A,B,C,D,DX,DXSQ,DY,DYSQ,P00,P01,P02,P03,P10,P11,   P12,P13,P20,P21,P22,P23,P30,P31,P32,P33,Q0,Q1,Q2,   Q3,U,V,X0,XII,Y0,YII,Z00,Z01,Z0DX,Z0DY,Z10,Z11,   Z1DX,Z1DY,ZDXDY,ZII,ZX00,ZX01,ZX0DY,ZX10,ZX11,   ZX1DY,ZXY00,ZXY01,ZXY10,ZXY11,ZY00,ZY01,ZY0DX,   ZY10,ZY11,ZY1DX
