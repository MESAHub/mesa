...
!  calculate ni56 electron capture and neutrino loss rates
      ...
      if ( (btemp < 2.0d9) .or. (bden*ye < 1.0d6)) return
...
502   iflag = iflag + 1
      if (iflag==1) etael = qn2/kerg/temp
      if (iflag==2) etael = c2me/kerg/temp
      if (iflag==2) etaef = -etaef
