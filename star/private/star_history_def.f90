...
! ***********************************************************************
   ...
   ! history column options
      ...
      integer, parameter :: h_log_tau_conv = h_tau_QHSE_yrs + 1
      integer, parameter :: h_dt_div_tau_conv = h_log_tau_conv + 1
      integer, parameter :: h_tau_conv = h_dt_div_tau_conv + 1
      integer, parameter :: h_tau_conv_hrs = h_tau_conv + 1
      integer, parameter :: h_tau_conv_days = h_tau_conv_hrs + 1
      integer, parameter :: h_tau_conv_sec = h_tau_conv_days + 1
      integer, parameter :: h_log_abs_Lgrav = h_tau_conv_sec + 1
      ...
      subroutine history_column_names_init(ierr)
         ...
         history_column_name(h_dt_div_tau_conv) = 'dt_div_tau_conv'
         history_column_name(h_tau_conv) = 'tau_conv'
         history_column_name(h_tau_conv_days) = 'tau_conv_days'
         history_column_name(h_tau_conv_hrs) = 'tau_conv_hrs'
         history_column_name(h_tau_conv_sec) = 'tau_conv_sec'
         history_column_name(h_log_tau_conv) = 'log_tau_conv'
