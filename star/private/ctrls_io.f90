...
! ***********************************************************************
 ...
 namelist /controls/ &
   ...
   RSP_relax_alfap_before_alfat, RSP_max_outer_dm_tries, RSP_max_inner_scale_tries, RSP_T_anchor_tolerance, &
    ...
    check_mass_sum_for_infall, use_drag_energy, drag_coefficient, min_q_for_drag, &
...
s% gradT_excess_max_log_tau_full_off = gradT_excess_max_log_tau_full_off
 ...
 s% check_mass_sum_for_infall = check_mass_sum_for_infall
 ...
 check_mass_sum_for_infall = s% check_mass_sum_for_infall
