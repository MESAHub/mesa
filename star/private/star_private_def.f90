...
! ***********************************************************************
      ...
      subroutine star_private_def_init
         ...
         auto_diff_star_d1_names(i_mu_m1) = 'i_mu_m1'
         auto_diff_star_d1_names(i_mu_00) = 'i_mu_00'
         auto_diff_star_d1_names(i_mu_p1) = 'i_mu_p1'
         auto_diff_star_d1_names(i_H1_m1) = 'i_H1_m1'
         auto_diff_star_d1_names(i_H1_00) = 'i_H1_00'
         auto_diff_star_d1_names(i_H1_p1) = 'i_h1_p1'
