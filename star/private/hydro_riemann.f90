...
!$omp end critical (dudt_eqn)
      ...
      subroutine eval_Riemann_dudt_rhs( &
            ...
            dudt_expected_ad, ierr, rhs_inner, mlt_vc_ad)
...
!$OMP END PARALLEL DO
      ...
      subroutine do1_uface_and_Pface(s, k, ierr, mlt_vc_ad)
         ...
         PR_ad = shift_m1(PR_ad)
         ! LNA excludes rotation and uses its triplet for the k-2 density partial.
         if (present(mlt_vc_ad)) PR_ad%d1Array(i_jrot_m1) = dPR_dlnd_m2
