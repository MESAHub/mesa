...
! ***********************************************************************
   ...
   ! profile column options
      ...
      integer, parameter :: p_th_results_K_therm = p_mlt_D + 1
      integer, parameter :: p_th_results_K_T = p_th_results_K_therm + 1
      integer, parameter :: p_th_results_K_C = p_th_results_K_T + 1
      integer, parameter :: p_th_results_nu = p_th_results_K_C + 1
      integer, parameter :: p_th_results_Pr = p_th_results_nu + 1
      integer, parameter :: p_th_results_tau = p_th_results_Pr + 1
      integer, parameter :: p_th_results_R_0 = p_th_results_tau + 1
      integer, parameter :: p_th_results_r = p_th_results_R_0 + 1
      integer, parameter :: p_th_results_H_B = p_th_results_r + 1
      integer, parameter :: p_th_results_Pm = p_th_results_H_B + 1
      integer, parameter :: p_th_results_D_B = p_th_results_Pm + 1
      integer, parameter :: p_th_results_lam_hat = p_th_results_D_B + 1
      integer, parameter :: p_th_results_l2_hat = p_th_results_lam_hat + 1
      integer, parameter :: p_th_results_sigma_max = p_th_results_l2_hat + 1
      integer, parameter :: p_th_results_k_z_max = p_th_results_sigma_max + 1
      integer, parameter :: p_th_results_w = p_th_results_k_z_max + 1
      integer, parameter :: p_th_results_w_HG19 = p_th_results_w + 1
      integer, parameter :: p_th_results_w_FRG24 = p_th_results_w_HG19 + 1
      integer, parameter :: p_th_results_Nu_C = p_th_results_w_FRG24 + 1
      integer, parameter :: p_th_results_D_thrm = p_th_results_Nu_C + 1
      integer, parameter :: p_mlt_gradT = p_th_results_D_thrm + 1
      ...
      subroutine profile_column_names_init(ierr)
         ...
         profile_column_name(p_th_results_K_therm) = 'th_results_K_therm'
         profile_column_name(p_th_results_K_T) = 'th_results_K_T'
         profile_column_name(p_th_results_K_C) = 'th_results_K_C'
         profile_column_name(p_th_results_nu) = 'th_results_nu'
         profile_column_name(p_th_results_Pr) = 'th_results_Pr'
         profile_column_name(p_th_results_tau) = 'th_results_tau'
         profile_column_name(p_th_results_R_0) = 'th_results_R_0'
         profile_column_name(p_th_results_r) = 'th_results_r'
         profile_column_name(p_th_results_H_B) = 'th_results_H_B'
         profile_column_name(p_th_results_Pm) = 'th_results_Pm'
         profile_column_name(p_th_results_D_B) = 'th_results_D_B'
         profile_column_name(p_th_results_lam_hat) = 'th_results_lam_hat'
         profile_column_name(p_th_results_l2_hat) = 'th_results_l2_hat'
         profile_column_name(p_th_results_sigma_max) = 'th_results_sigma_max'
         profile_column_name(p_th_results_k_z_max) = 'th_results_k_z_max'
         profile_column_name(p_th_results_w) = 'th_results_w'
         profile_column_name(p_th_results_w_HG19) = 'th_results_w_HG19'
         profile_column_name(p_th_results_w_FRG24) = 'th_results_w_FRG24'
         profile_column_name(p_th_results_Nu_C) = 'th_results_Nu_C'
         profile_column_name(p_th_results_D_thrm) = 'th_results_D_thrm'
