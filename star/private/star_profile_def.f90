...
! ***********************************************************************
   ...
   ! profile column options
      ...
      integer, parameter :: p_thrm_extras_Pr = p_mlt_D + 1
      integer, parameter :: p_thrm_extras_tau = p_thrm_extras_Pr + 1
      integer, parameter :: p_thrm_extras_R0 = p_thrm_extras_tau + 1
      integer, parameter :: p_thrm_extras_DB = p_thrm_extras_R0 + 1
      integer, parameter :: p_thrm_extras_HB = p_thrm_extras_DB + 1
      integer, parameter :: p_thrm_extras_lamhat = p_thrm_extras_HB + 1
      integer, parameter :: p_thrm_extras_l2hat = p_thrm_extras_lamhat + 1
      integer, parameter :: p_thrm_extras_w = p_thrm_extras_l2hat + 1
      integer, parameter :: p_thrm_extras_w_TC = p_thrm_extras_w + 1
      integer, parameter :: p_thrm_extras_w_HG19 = p_thrm_extras_w_TC + 1
      integer, parameter :: p_thrm_extras_D_thrm = p_thrm_extras_w_HG19 + 1
      integer, parameter :: p_mlt_gradT = p_thrm_extras_D_thrm + 1
      ...
      subroutine profile_column_names_init(ierr)
         ...
         profile_column_name(p_thrm_extras_Pr) = 'thrm_extras_Pr'
         profile_column_name(p_thrm_extras_tau) = 'thrm_extras_tau'
         profile_column_name(p_thrm_extras_R0) = 'thrm_extras_R0'
         profile_column_name(p_thrm_extras_HB) = 'thrm_extras_HB'
         profile_column_name(p_thrm_extras_DB) = 'thrm_extras_DB'
         profile_column_name(p_thrm_extras_lamhat) = 'thrm_extras_lamhat'
         profile_column_name(p_thrm_extras_l2hat) = 'thrm_extras_l2hat'
         profile_column_name(p_thrm_extras_w) = 'thrm_extras_w'
         profile_column_name(p_thrm_extras_w_TC) = 'thrm_extras_w_TC'
         profile_column_name(p_thrm_extras_w_HG19) = 'thrm_extras_w_HG19'
         profile_column_name(p_thrm_extras_D_thrm) = 'thrm_extras_D_thrm'
