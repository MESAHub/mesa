...
parser.add_argument('-p', metavar='p', type=str, default=None,
                    help='Specifies the starting photo.')
parser.add_argument('-N', metavar='N', type=int, default=5,
                    help='The first N and last N photos by modified-time '
                         'will be stashed.')
parser.add_argument('-m', metavar='m', type=str, default='',
                    help='Notes about the experiment.')
parser.add_argument('--png', action='store_true',
                    help='Stash png files. If specified png files will be '
                         'stashed and then removed from the working '
                         'directory.')
...
def ignore(path, names):
    ...
    if not args.png:
        ...
        copied_pngs = copied_pngs + list(
            path + '/' + n for n in names if n[-4:] == '.png')
