...
use gyre_mesa_m
      ...
      implicit none
      include '/Users/eb/Documents/Software/dev/mesa_release/mesa/star/rsp2_utils/run_star_extras_rsp2_defs.inc'
      ...
      include '/Users/eb/Documents/Software/dev/mesa_release/mesa/star/rsp2_utils/run_star_extras_rsp2.inc'
...
!s% other_photo_read => photo_read
      ...
      subroutine extras_startup(id, restart, ierr)
         use star_lib, only: remesh_for_TDC_pulsation
         integer, intent(in) :: id
...
!if (.not. restart .and. in_inlist_pulses) &
!s% job% remove_center_by_temperature = 2d6
