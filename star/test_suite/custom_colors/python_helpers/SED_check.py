...
class SEDChecker:
    ...
    def update_plot(self, frame):
        ...
        if self.save_video:
            ...
            if self.frame_counter % 10 == 0:
                print(
                    f"Creating video: Frame {self.frame_counter}/{
        ...
        for file_path in output_files:
            ...
            try:
                ...
                if (
                    wavelengths is not None
                    and len(wavelengths) > 0
                    and convolved_flux is not None
                    and len(convolved_flux) > 0
                ):
                    self.ax.plot(
                        wavelengths,
                        convolved_flux,
    ...
    def run(self):
        ...
        if self.save_video:
            ...
            print(
                f"Video settings: {self.video_fps} fps, {self.video_duration} seconds"
            )
