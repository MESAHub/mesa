...
class HistoryChecker:
    ...
    def update_data(self):
        ...
        try:
            ...
            self.hr_color, self.hr_mag, self.hr_xlabel, self.hr_ylabel, self.color_index = \
    ...
    def update_plot(self, frame):
        ...
        if len(self.phases) > 0:
            self.axes[0, 0].scatter(self.hr_color, self.hr_mag, c=self.phase_colors, 
        ...
        if len(self.phases) > 0:
            self.axes[0, 1].scatter(self.Teff, self.Log_L, c=self.phase_colors, 
                                   s=20, alpha=0.7, edgecolors='none')
        else:
        ...
        if len(self.phases) > 0:
            self.axes[1, 0].scatter(self.Star_Age, self.color_index, c=self.phase_colors, 
                                   s=20, alpha=0.7, edgecolors='none')
        else:
        ...
        if len(self.phases) > 0:
            ...
            self.fig.legend(handles=legend_elements, loc='upper center', bbox_to_anchor=(0.5, 0.54), 
                          ncol=ncol, title_fontsize=16, fontsize=16,
