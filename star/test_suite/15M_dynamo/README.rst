...
.. code-block:: console
 ...
 &pgstar
   ...
   file_extension = 'ps'
    ...
    Profile_Panels_txt_scale(4) = 0.8

    Profile_Panels_win_flag(4) = .true.
    Profile_Panels_win_width(4) = 10

    Profile_Panels_file_flag(4) = .true.
    Profile_Panels_file_dir(4) = 'png'
    Profile_Panels_file_prefix(4) = 'profile_Panels4_'
    Profile_Panels_file_interval(4) = 10
    Profile_Panels_file_width(4) = 10
