...
plt.plot(R_0, D2, label=r'$H_B = H_{B2}$ from inlist', ls='--', dashes=(1,1), lw=1.2, c='tab:blue')
plt.plot(R_0, D1, label=r'$H_B = H_{B1}$ from inlist', ls='--', dashes=(1,1), lw=1.2, c='tab:green')
plt.plot(R_0, D0, label=r'$H_B = 0$', ls='--', dashes=(4,2), lw=1.2, c='tab:gray')

plt.scatter(R_0, D2_frg, s=10, color='tab:blue')
plt.scatter(R_0, D1_frg, s=7, color='tab:green')
plt.scatter(R_0, D0_frg, s=7, color='tab:gray')
