...
contains
   ...
   subroutine analytical_estimate_th(maxl, lambdamax, r_th, prandtl, diffratio)
      ...
      real(dp), intent(in) :: r_th, prandtl, diffratio
      real(dp), intent(out) :: maxl, lambdamax
      real(dp) :: phi, maxl4, maxl6
   ...
   subroutine NR(xrk, prandtl, diffratio, R0, ierr)
      ...
      real(dp), intent(inout) :: xrk(2)
      real(dp), intent(in) :: prandtl, diffratio, R0
      integer, intent(out) :: ierr
      integer :: iter
      real(dp) :: f(2)  ! Functions f
