...
contains
   ...
   subroutine do_star_plot(b, id, device_id, xleft, xright, &
      ybot, ytop, subplot, title, txt_scale_factor, &
      ...
      case(1)
         ...
         if (b% point_mass_i /= 1) then
            ...
            call pgqch(current_scale)
            call pgsch(txt_scale_factor * current_scale)
      ...
      subroutine plot_case(s, star_id)
         ...
         case ('abundance')
            call do_abundance_plot(&
               ...
               s% pg% Abundance_title, txt_scale_factor * s% pg% Abundance_txt_scale, ierr)
         case ('power')
            call do_power_plot(&
               s, star_id, device_id, xleft, xright, ybot, ytop, star_subplot, &
               s% pg% Power_title, txt_scale_factor * s% pg% Power_txt_scale, ierr)
         case ('mixing')
            call do_Mixing_plot(&
               s, star_id, device_id, xleft, xright, ybot, ytop, star_subplot, &
               s% pg% Mixing_title, txt_scale_factor * s% pg% Mixing_txt_scale, ierr)
         case ('dynamo')
            call do_Dynamo_plot(&
               s, star_id, device_id, xleft, xright, ybot, ytop, star_subplot, &
               s% pg% Dynamo_title, txt_scale_factor * s% pg% Dynamo_txt_scale, ierr)
         case ('trho')
            call do_TRho_plot(&
               s, star_id, device_id, xleft, xright, ybot, ytop, star_subplot, &
               s% pg% TRho_title, txt_scale_factor * s% pg% TRho_txt_scale, ierr)
         case ('mode_prop')
            call do_mode_propagation_plot(&
               s, star_id, device_id, xleft, xright, ybot, ytop, star_subplot, s% pg% Mode_Prop_title, &
               txt_scale_factor * s% pg% Mode_Prop_txt_scale, ierr)
         case ('summary_burn')
            call do_summary_burn_plot(&
               s, star_id, device_id, xleft, xright, ybot, ytop, star_subplot, s% pg% Summary_Burn_title, &
               txt_scale_factor * s% pg% Summary_Burn_txt_scale, ierr)
         case ('summary_profile')
            call do_summary_profile_plot(&
               ...
               txt_scale_factor * s% pg% Summary_Profile_txt_scale, ierr)
         ...
         case ('profile_panels1')
            call do_Profile_Panels1_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels1_txt_scale, ierr)
         case ('profile_panels2')
            call do_Profile_Panels2_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels2_txt_scale, ierr)
         case ('profile_panels3')
            call do_Profile_Panels3_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels3_txt_scale, ierr)
         case ('profile_panels4')
            call do_Profile_Panels4_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels4_txt_scale, ierr)
         case ('profile_panels5')
            call do_Profile_Panels5_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels5_txt_scale, ierr)
         case ('profile_panels6')
            call do_Profile_Panels6_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels6_txt_scale, ierr)
         case ('profile_panels7')
            call do_Profile_Panels7_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels7_txt_scale, ierr)
         case ('profile_panels8')
            call do_Profile_Panels8_plot(&
               ...
               txt_scale_factor * s% pg% Profile_Panels8_txt_scale, ierr)
         ...
         case ('history_panels1')
            call do_History_Panels1_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels1_txt_scale, ierr)
         case ('history_panels2')
            call do_History_Panels2_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels2_txt_scale, ierr)
         case ('history_panels3')
            call do_History_Panels3_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels3_txt_scale, ierr)
         case ('history_panels4')
            call do_History_Panels4_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels4_txt_scale, ierr)
         case ('history_panels5')
            call do_History_Panels5_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels5_txt_scale, ierr)
         case ('history_panels6')
            call do_History_Panels6_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels6_txt_scale, ierr)
         case ('history_panels7')
            call do_History_Panels7_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels7_txt_scale, ierr)
         case ('history_panels8')
            call do_History_Panels8_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels8_txt_scale, ierr)
         case ('history_panels9')
            call do_History_Panels9_plot(&
               ...
               txt_scale_factor * s% pg% History_Panels9_txt_scale, ierr)
         case ('color_magnitude1')
            call do_Color_Magnitude1_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude1_txt_scale, ierr)
         case ('color_magnitude2')
            call do_Color_Magnitude2_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude2_txt_scale, ierr)
         case ('color_magnitude3')
            call do_Color_Magnitude3_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude3_txt_scale, ierr)
         case ('color_magnitude4')
            call do_Color_Magnitude4_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude4_txt_scale, ierr)
         case ('color_magnitude5')
            call do_Color_Magnitude5_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude5_txt_scale, ierr)
         case ('color_magnitude6')
            call do_Color_Magnitude6_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude6_txt_scale, ierr)
         case ('color_magnitude7')
            call do_Color_Magnitude7_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude7_txt_scale, ierr)
         case ('color_magnitude8')
            call do_Color_Magnitude8_plot(&
               ...
               txt_scale_factor * s% pg% Color_Magnitude8_txt_scale, ierr)
