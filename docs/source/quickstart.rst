...
The first thing to do is to follow exactly the installation steps explained in :ref:`Installing MESA`.
...
When you do that, **it is important to follow the clear procedure detailed in the troubleshooting section of** :ref:`Installing MESA`. This tells you which information you need to provide for people to be able to help you.
...
Some of these test cases are documented in detail in the :ref:`Test suite documentation <Test suite>`. 
