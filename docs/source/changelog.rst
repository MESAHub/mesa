...
Fixed a bug where mesh adjustments could introduce spurious structure into
angular velocity profiles while conserving total angular momentum. See
`gh-1047 <https://github.com/MESAHub/mesa/issues/1047>`_.
