...
! ***********************************************************************
      ...
      logical, parameter :: plus_co56 = .false.
      ...
      integer :: ico56, ife53, ife55
      
      integer, parameter :: approx21_num_mesa_reactions = 93, approx21_nrat = 116
      
      integer, parameter :: num_mesa_reactions = approx21_num_mesa_reactions
      integer, parameter :: num_reactions = approx21_nrat
      ...
      integer :: irco56ec ! not used, but must be defined for shared code
