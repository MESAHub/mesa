...
# Download the photon weigthed values from
# http://vizier.cfa.harvard.edu/viz-bin/VizieR-3?-source=J/A%2bAS/130/65
# /lcb98cor
...
with open(file_out, 'w') as f:
    ...
    for y in zip(x['Teff'], x['logg'], x['FeH'], U, B, V, R, I, J, K, H, L,
                 Lprime, M):
