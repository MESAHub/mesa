...
contains
   ...
   subroutine do_one_colors
      ...
      real(dp), dimension(num_results), parameter :: solar_expected_results = [ &
                                                     4.75d0, -0.11510d0, -0.14211d0, -0.61768d0, -0.36199d0, -0.68894d0, &
                                                     -1.46926d0, -0.32695d0, -0.78032d0, -0.39024d0, 0.05223d0, &
                                                     -0.10512d0, -0.33801d0, -0.44312d0, -0.44123d0, -0.43080d0]
   ...
   subroutine create_plot_files
      ...
      do i = 1, num_masses
         ...
         results(15) = &
            get_bc_by_name('J', logteff(i), log_g, M_div_h, info) - get_bc_by_name('Lprime', logteff(i), log_g, M_div_h, info)
