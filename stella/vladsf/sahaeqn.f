...
c (real(dp)) PRESS must contain the pressure if KURUCZ is set to true.
c (real(dp)) TEMP is the temperature.
c (real(dp)) EDEN is the electron density.
