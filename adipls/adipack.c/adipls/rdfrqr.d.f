      subroutine rdfrqr(icase,ids,cs,el,nord,sig,frq,ekin,ierr)
c
...
c  (in microHz) and dimensionless energy in el, nord, sig, frq and ekin.
c
...
c
c  original version: 28/4/99. This is identical to rdfreq.d.f,
c  except that the degree is returned as a real variable el,
c  rather than as an integer variable l
c
c                     ................................
c
...
c
        read(ids,*,end=92,err=95) el,nord,frq
        sig=0
        ekin=0
c
        go to 90
...
c
        ...
        if(frq.le.0) then
          ...
          frq1=1.d6/(2.d0*twopi)*sqrt(cgrav*cs(2)*sig/cs(3)**3)
