      subroutine rdfrqe(icase,ids,cs,l,nord,sig,frq,ekin,error,
     *  ierr)
c
...
c  icase = 6: observed frequencies, including errors in column 4
c  icase = 7: `observed frequencies', including inertia in column 4
c
...
c
        go to 90
c
      else if(icasea.eq.3.or.icasea.eq.6.or.icasea.eq.7) then
c
c  observed frequencies, possibly with errors or inertia
c
