module skye_ideal
   ...
   type(auto_diff_real_2var_order3_array) function compute_F_rad(temp, den) result(Frad)
   ...
   type(auto_diff_real_2var_order3_array) function compute_F_ideal_ion(temp, den, abar, species, weights, ya) result(F_ideal_ion)
      type(auto_diff_real_2var_order3_array), intent(in) :: temp, den
      integer, intent(in) :: species
      real(dp), intent(in) :: weights(species), ya(species), abar

      integer :: j
      type(auto_diff_real_2var_order3_array) :: n, nj, nQ, nQj
      type(auto_diff_real_2var_order3_array) :: y, yy, z
      type(auto_diff_real_2var_order3_array) :: kt, xni, etaion
   ...
   type(auto_diff_real_2var_order3_array) function compute_xne(den, ytot1, zbar) result(xne)
      type(auto_diff_real_2var_order3_array), intent(in) :: den
      real(dp), intent(in) :: ytot1, zbar
      type(auto_diff_real_2var_order3_array) :: xni
   ...
   subroutine compute_ideal_ele(temp_in, den_in, din_in, logtemp_in, logden_in, zbar, ytot1, ye, ht, s, e, p, adr_etaele, adr_xnefer, ierr)
      ...
      type(auto_diff_real_2var_order3_array), intent(out) :: adr_etaele, adr_xnefer, s, e, p
