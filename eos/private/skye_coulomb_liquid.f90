module skye_coulomb_liquid
   ...
   function liquid_mixing_rule_correction(RS,GAME,Zmean,Z2mean,Z52,Z53,Z321) result(FMIX)
      ...
      type(auto_diff_real_2var_order3_1var_order2), intent(in) :: Zmean,Z2mean,Z52,Z53,Z321

      type(auto_diff_real_2var_order3_1var_order2) :: GAMImean, Dif0, DifR, DifFDH, D
      type(auto_diff_real_2var_order3_1var_order2) :: P3, D0, GP, FMIX0, Q, R, GQ
      
      type(auto_diff_real_2var_order3_1var_order2) :: FMIX
