module skye_thermodynamics
   ...
   subroutine thermodynamics_from_free_energy(F, temp, den, s, e, p)
      type(auto_diff_real_2var_order3_dArray), intent(in) :: F
      type(auto_diff_real_2var_order3_dArray), intent(in) :: temp, den
      type(auto_diff_real_2var_order3_dArray), intent(out) :: s, e, p
   ...
   subroutine compute_derived_quantities(temp, dens, s, e, p, cv, cp, chit, chid, gam1, gam2, gam3, nabad, cs)
      ...
      type(auto_diff_real_2var_order3_dArray), intent(in) :: temp, dens, s, e, p
      type(auto_diff_real_2var_order3_dArray), intent(out) :: cv, cp, chit, chid, gam1, gam2, gam3, nabad, cs
   ...
   subroutine pack_for_export(F_ideal_ion, F_coul, F_rad, temp, dens, xnefer, etaele, abar, zbar, &
                                          ...
                                          res, d_dlnRho, d_dlnT)
      use eos_def
      type(auto_diff_real_2var_order3_dArray), intent(in) :: F_ideal_ion, F_coul, F_rad, temp, dens, xnefer, etaele
      type(auto_diff_real_2var_order3_dArray), intent(in) :: pele, eele, sele, phase, latent_ddlnT, latent_ddlnRho
      real(dp), intent(in) :: abar, zbar

      ! Intermediates
      type(auto_diff_real_2var_order3_dArray) :: srad, erad, prad, sgas, egas, pgas, p, e, s
      type(auto_diff_real_2var_order3_dArray) :: F_ion_gas, lnS, lnE, lnPgas, mu, lnfree_e
      type(auto_diff_real_2var_order3_dArray) :: cv, cp, chit, chid, gam1, gam2, gam3, nabad, cs
