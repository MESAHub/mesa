...
contains
   ...
   subroutine Do_CO_Test(data_dir, type1_table)
      ...
      write (*, *) 'info', info
      write (*, '(a40,1pe26.16)') 'logT', logT
      write (*, '(a40,1pe26.16)') 'logRho', logRho
      write (*, '(a40,1pe26.16)') 'z', z
      write (*, '(a40,1pe26.16)') 'xh', x
      write (*, *)
      write (*, '(a40,1pe26.16)') 'kap', 10**logK
      write (*, '(a40,1pe26.16)') 'logK', logK
      write (*, *)
